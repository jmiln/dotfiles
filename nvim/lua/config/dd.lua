-- This is grabbed from https://gitlab.com/yorickpeterse/nvim-dd/-/tree/main
-- since Packer doesn't seem to want to load it properly
local M = {}
local fn = vim.fn
local lsp = vim.lsp
local api = vim.api
...
function M.setup(options)
    ...
    augroup defer_diagnostics
      autocmd!
      au InsertLeave * lua require('config.dd').flush()
    augroup END
  ]])
